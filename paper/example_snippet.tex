...
\textbf{T1} \emph{(seed, human-labeled)}: \foreignlanguage{brazil}{``Criação de fundo para prevenção de desastres naturais e e recuperação de seus efeitos, para\ldots''}\\
$\rightarrow$ top: \textbf{PL 295/2007} --- \emph{relevant}\\[3pt]
\textbf{T2} \emph{(follow-up)}: \foreignlanguage{brazil}{``Quais são os principais critérios e mecanismos de distribuição dos recursos do fundo para\ldots''}\\
$\rightarrow$ top: \textbf{PL 5067/2016} --- \emph{relevant}\\[3pt]
\textbf{T3} \emph{(clarification)}: \foreignlanguage{brazil}{``Em quais situações específicas os recursos do fundo para prevenção de desastres naturais e\ldots''}\\
$\rightarrow$ top: \textbf{PL 10898/2018} --- \emph{relevant}\\[3pt]
\textbf{T4} \emph{(clarification)}: \foreignlanguage{brazil}{``Como são definidas as prioridades para a alocação de recursos do fundo em situações de\ldots''}\\
